...
ggplot(MessiMinutesSeason, mapping=aes(x=season, y=avg.match, group=1)) +
  geom_line(color="blue") +
  geom_point() +
  geom_text(aes(x=season, y=avg.match, label=matches),size = 2.5, nudge_y = 2, nudge_x = -0.05) +
